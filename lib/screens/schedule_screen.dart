        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              ...employees.map((emp) {
                final schedule = emp['schedule'] as List<String>;
                return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      ...schedule.map((s) {
                        final c = s == 'full' ? AppConstants.primaryColor
                            : s == 'morning' ? Colors.orange
                            : s == 'afternoon' ? Colors.blue
                            : Colors.grey.withOpacity(0.3);
                        final label = s == 'full' ? 'I'
                            : s == 'morning' ? 'M'
                            : s == 'afternoon' ? 'T'
                            : '-';
                        return Expanded(
                          child: Container(
                            ...
                            child: Text(
                              label,
                              style: TextStyle(
                                color: s == 'off' ? Colors.grey : Colors.white,
                                fontSize: 12,
